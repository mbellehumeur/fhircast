...
import RadaiService from './services/ProjectSpecific/RadaiService';
...
export default {
  ...
  preRegistration: ({ servicesManager, commandsManager, configuration = {} }) => {
       servicesManager.registerService(FhircastService.REGISTRATION(servicesManager));
       servicesManager.registerService(RadaiService.REGISTRATION(servicesManager));
  },
  /**
